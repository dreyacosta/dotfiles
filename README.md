...
zoxide, bat, eza, and gum commands to already be available. Mise installs the
configured Go, Node, and Python runtimes on Linux; macOS uses mise for Go and
Python while nvm remains the Node version manager.
